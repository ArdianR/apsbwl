    	...
    	<div class="row">
    		<div class="col-md-7">
    			<div class="box box-primary">
    				...
    				<div class="box-body">
    					{{Form::open(['url'=>'admin', 'method'=>'post', 'class'=>'form'])}}

    						<div class="form-group {{$errors->has('nama') ? 'has-error' : ''}}">
    							{{Form::input('text', 'nama', Input::old('nama'), ['class'=>'form-control', 'placeholder'=>'Nama', 'id'=>'nama', 'required'])}}
                            ...
                            <div class="form-group {{$errors->has('username') ? 'has-error' : ''}}">
                                {{Form::input('text', 'username', Input::old('username'), ['class'=>'form-control', 'placeholder'=>'Username', 'id'=>'username', 'required'])}}
                            ...
                            <div class="form-group {{$errors->has('email') ? 'has-error' : ''}}">
                                {{Form::email('email', Input::old('email'), ['class'=>'form-control', 'placeholder'=>'Email', 'id'=>'email', 'required'])}}
