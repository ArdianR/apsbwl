    		...
    		<div class="col-md-7">
    			<div class="box box-danger">
    				<div class="box-header">
    					<h3 class="box-title">Form Input Guru</h3>
    				</div>
    				<div class="box-body">
    					{{Form::open(['url'=>'guru', 'method'=>'post', 'class'=>'form'])}}

    						<div class="form-group {{$errors->has('niy') ? 'has-error' : ''}}">
    							{{Form::input('text', 'niy', Input::old('niy'), ['class'=>'form-control', 'placeholder'=>'NIY', 'id'=>'niy', 'required'])}}
    							{{$errors->first('niy', '<span class="help-block">:message</span>')}}
    						</div>

    						<div class="form-group {{$errors->has('nuptk') ? 'has-error' : ''}}">
    							{{Form::input('text', 'nuptk', Input::old('nuptk'), ['class'=>'form-control', 'placeholder'=>'NUPTK', 'id'=>'nuptk', 'required'])}}
    						...
    						<div class="form-group {{$errors->has('pendidikan') ? 'has-error' : ''}}">
    							{{Form::input('text', 'pendidikan', Input::old('pendidikan'), ['class'=>'form-control', 'placeholder'=>'Pendidikan Terakhir', 'id'=>'pendidikan', 'required'])}}
    							{{$errors->first('pendidikan', '<span class="help-block">:message</span>')}}
    						</div>

    						<div class="form-group {{$errors->has('nama_guru') ? 'has-error' : ''}}">
    							{{Form::input('text', 'nama_guru', Input::old('nama_guru'), ['class'=>'form-control', 'placeholder'=>'Nama Guru', 'id'=>'nama_guru', 'required'])}}
